        ...
        selected_rows.append(
            {
                ...
                "test_cagr": float(summary.get("cagr", 0.0) or 0.0),
                "test_cagr_to_ulcer": float(summary.get("cagr_to_ulcer", 0.0) or 0.0),
                "test_r_squared": float(summary.get("r_squared", 0.0) or 0.0),
                "test_hurst_exponent": float(summary.get("hurst_exponent", 0.0) or 0.0),
                "test_calmar": float(summary.get("calmar", 0.0) or 0.0),
